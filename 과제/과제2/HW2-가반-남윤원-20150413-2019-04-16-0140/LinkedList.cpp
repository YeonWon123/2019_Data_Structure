...
int main()
{
	...
	linkedlist4.PrintLinkedList();	cout << endl;
	cout << "merge 이후 linkedlist1 출력 - linkedlist1.PrintLinkedListBackward() 결과 \n\n";
	linkedlist4.PrintLinkedListBackward();	cout << endl;
	...
	linkedlist1.PrintLinkedList();	cout << endl;
	...
	linkedlist6.quicksort(linkedlist6.getHead(), linkedlist6.getTail());
